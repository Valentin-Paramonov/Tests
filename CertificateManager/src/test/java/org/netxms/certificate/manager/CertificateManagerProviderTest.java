...
public class CertificateManagerProviderTest {
    ...
    private final CertificateManagerProviderRequestListener
    ...
    public void testProvideCertificateManager_ProvidesManager() {
        manager = CertificateManagerProvider
            .provideCertificateManager(testListener);
    ...
    public void testProvideCertificateManage_SameInstance() {
        CertificateManager mgr1 =
            CertificateManagerProvider.provideCertificateManager(testListener);
        CertificateManager mgr2 =
            CertificateManagerProvider.provideCertificateManager(testListener);
